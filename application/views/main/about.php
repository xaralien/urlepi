        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="<?= base_url('assets/'); ?>img/about.png" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="mb-4">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">About Us</h5>
                    <h1 class="display-4">Tempat Terbaik untuk memperbaiki Laptop kesayangan Anda</h1>
                </div>
                <p>Kami adalah perusahaan yang menyediakan jasa service untuk seluruh indonesia, kami melakukan diagnosis secara online dan menganjurkan pengguna untuk melakukan perbaikan atau pengguna dapat memperbaiki laptop kepada kami, tidak hanya itu. kami juga menyediakan spare part untuk memperbaiki laptop anda</p>
