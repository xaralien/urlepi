...
<div class="container-fluid bg-primary my-5 py-5">
    ...
    <div class="container py-5">
        <div class="row gx-5">
            <?php
            if ($status == "Solusi Terkirim!" || $status == "Bukti Pembayaran Di Tolak!" || $status == "Proses Pembayaran" || $status == "Proses Persetujuan" || $status == "SELESAI!") {
            ?>
                ...
                <a class="btn btn-outline-dark rounded-pill py-3 px-5" href="">Read More</a> -->
                    ...
                    <?php if ($status == "Solusi Terkirim!") {
                    ?>
                        <div class="col-lg-5" style="margin-left:5%;margin-top: 9.5%;">
                            <div class="bg-white text-center rounded p-5">
                                <h1 class="mb-4">Silahkan Pilih</h1>
                                <!-- <h1 class="mb-4">Kirim Bukti</h1> -->
                                <div class="row g-3">
                                    <div class="col-12">
                                        <form method="post" action="<?= base_url('diagnosa/servicesekarang/' . $id); ?>">
                                            <button class="btn btn-primary w-100 py-3" type="submit">Service Sekarang</button>
                                        </form>
                                        <br>
                                        <form method="post" action="<?= base_url('diagnosa/selesai/' . $id); ?>">
                                            <button class="btn btn-success w-100 py-3" type="submit">Selesai!</button>
                                        </form>
                                        <!-- <br>
                    ...
                    <?php } else if ($status == "Proses Persetujuan") {
                    ?>
                        <div class="col-lg-6" style="margin-top: 9.5%;">
                            ...
                            <div class="col-12 col-sm-6">
                                <select class="form-select bg-light border-0" style="height: 55px;">
                                    ...
                                    <label style="float: left; " for=""><b>BUKTI HARGA</b> </label>

                                    <img class=" rounded" src="data:;base64,<?php echo $bukti_harga; ?>" style="max-width:100%;max-height:auto;">

                                    <div class="col-12">

                                        <label style="float: left; " for=""><b>Masukan Bukti Pembayaran Akhir</b> </label>

                                        <label for=""><b>Rp.<?= $total_harga ?>,00 </b></label>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="time" id="time" data-target-input="nearest">
                                    ...
                                    <div class="col-12">
                                        <a href="<?= base_url('diagnosa/tentukan/' . $id); ?>" class="btn btn-primary w-100 py-3">Pilih Metode</a>

                                        <form action="<?= base_url('diagnosa/bataldiagnosa/' . $id); ?>" method="post">
                                            <br>
                    ...
                    <?php } else if ($status == "Proses Pembayaran" || $status == "Bukti Pembayaran Di Tolak!") {
                    ?>
                        <div class="col-lg-6 " style="margin-top: 9.5%;">
                            <div class="bg-white text-center rounded p-5">
                                <!-- <p>Cara Transaksi <a href=""><b> Disini</b></a></p> -->
                                <h1 class="mb-4">Kirim Bukti</h1>
                                <form method="post" action="<?= base_url('diagnosa/buktipembayaran/' . $id); ?>" enctype="multipart/form-data">
                                    <div class="row g-3">
