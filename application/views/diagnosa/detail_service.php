        ...
        <div class="row gx-5">
            <div class="col-lg-6">
                <div class="bg-white text-center rounded p-5">
                    ...
                    <form method="post" action="<?= base_url('diagnosa/pilih/' . $this->uri->segment(3)); ?>">
                        <div class="row g-3">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="mb-4">
                    ...
                    <h1 class="display-4">Silahkan Pilih Metode</h1>
                </div>
                <p class="text-white mb-5">
                    Terima Kasih telah memilih jasa kami, kami akan melakukan yang terbaik!
