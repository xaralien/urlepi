...
<div class="container-fluid bg-primary my-5 py-5">
    ...
    <div class="container py-5">
        <div class="row gx-5">
            <?php
            if ($status == "Proses Pembayaran" || $status == "Bukti Pembayaran Di Tolak!" || $status == "Proses Pembayaran Akhir" || $status == "Bukti Pembayaran Tambahan Di Tolak!") {
            ?>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <form method="post" action="<?= base_url('pesanan/selesaiperbaiki/' . $id); ?>">
                                            <input type="hidden" name="metode_kirim" value="<?= $metode_kirim ?>">
                                            <button class="btn btn-primary w-100 py-3" type="submit">Lewati</button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        ?>
                                            ...
                                            <a href="<?= base_url('pesanan/pakaigaransi/' . $id); ?>" class="btn btn-success w-100 py-3" style="margin-top: 10px;">Gunakan Garansi</a>
                                        <?php
                                        }
                                        ?>
                                    </div>
