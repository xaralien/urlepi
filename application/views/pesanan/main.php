                    ...
                    <?php foreach ($order as $o) { ?>
                        <tr scope="row">
                            ...
                            <?php if ($o->status == "BATAL!") { ?>
                                <td><a href="<?= base_url('pesanan/detail/' . $o->id) ?>" class=" btn btn-danger"> <?= $o->status ?></a></td>
                            <?php } else if ($o->status == "SELESAI!") { ?>
                                <td><a href="<?= base_url('pesanan/detail/' . $o->id) ?>" class=" btn btn-success"> <?= $o->status ?></a></td>
                            <?php } else { ?>
                                <td><a href="<?= base_url('pesanan/detail/' . $o->id) ?>" class=" btn btn-warning"> <?= $o->status ?></a></td>
