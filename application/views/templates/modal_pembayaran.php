    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="color: #13C5DD;">Login</h5>
                <button class="btn btn-danger" type="button" class="close" data-dismiss="modal">
                    X
                </button>
            </div>
            <img class="" src="<?= base_url('assets/'); ?>img/logo.png" style="max-width: 30%; margin-left: auto; margin-right:auto; margin-top: 10px;">
            <h1 class=" text-uppercase text-primary" style="margin-left: auto; margin-right:auto; ">UrLepi</h1>
            <form action="<?= base_url('member'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group row mb-1">
                        <label for="email" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control border-1" id="email" name="email" placeholder="Alamat Email">
                        </div>
                    </div>
